...
const releaseAcceptanceUrl = `${githubBlobRoot}/docs/v0.4-release-acceptance.md`;
        ...
        <section className="hero section-shell" id="top">
          <div className="hero-copy">
            <div className="hero-brand">
              ...
              <ExternalLink href={releaseAcceptanceUrl}>Stable v0.4.0</ExternalLink>
            </div>
            <h1>
              让高危工具调用，
              <span>
          ...
          <div className="download-layout">
            <div className="download-list">
              ...
              <ExternalLink
                ...
                href={`${githubRoot}/releases/tag/v0.4.0`}
              >
                下载可复跑评估附件
                <Icon name="external" />
              </ExternalLink>
