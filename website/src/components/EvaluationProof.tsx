  ...
  return (
    <section className="section section-shell evaluation-proof" id="evaluation">
      <div className="evaluation-heading">
        <div>
          <p className="evaluation-kicker">REAL CODEX + RELEASE CI</p>
          <h2>实测证据</h2>
          <p>
            {evaluationProof.subject.releaseTag} 正式评估附件已在原生 Windows / Linux
            runner 复跑（CI #{evaluationProof.run.id}）；真实 Codex 证据仍来自{" "}
            {realCodexProof.runtime.releaseTag} /{" "}
      ...
      <div className="evaluation-source-links" aria-label="公开验证资料">
        <span>证据</span>
        <a href={releaseProofUrl} rel="noreferrer" target="_blank">
